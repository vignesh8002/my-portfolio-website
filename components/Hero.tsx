...
export default function Hero() {
  ...
  return (
    <section
      ...
      className="relative w-full min-h-[100svh] flex items-center bg-[#050508] overflow-hidden pt-24 pb-16 lg:py-0"
    >
      ...
      <div className="sc w-full py-8 lg:py-16 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-8 items-center">
          ...
          <div className="lg:col-span-7 flex flex-col justify-center order-1 relative z-20">
            ...
            <div className="flex items-center gap-3 mb-6 animate-fade-in">
              ...
              <p className="text-[11px] font-semibold uppercase tracking-[0.28em] text-blue-400/90">
            ...
            <h1
              id="hero-headline"
              className="font-serif font-black leading-[0.93] tracking-tight text-white
                         text-[clamp(2.85rem,7.5vw,5.75rem)]
            ...
            >
              ...
              <br />
              <span className="text-[0.62em] text-gray-300/90 font-normal italic font-serif tracking-normal">
                Ascend the Brain.
              </span>
            </h1>
            ...
            <div
              className="flex flex-col sm:flex-row sm:items-start gap-6 sm:gap-8 mb-8 animate-slide-up"
            ...
            {/* Buttons */}
            <div
              className="flex flex-wrap items-center gap-3.5 mb-10 animate-slide-up"
            ...
            <div
              className="pt-6 border-t border-white/[0.06] flex flex-wrap items-center gap-4 text-xs animate-fade-in"
          ...
          <div className="lg:col-span-5 relative z-10 flex justify-center lg:justify-end items-center order-2 w-full">
            <div
              className="relative w-full max-w-lg lg:max-w-xl aspect-[4/5] sm:aspect-[1/1] lg:aspect-[4/5] flex items-center justify-center animate-fade-in"
              style={{ animationDelay: "0.2s" }}
            >
              {/* Backlight halo behind subject to create rim separation */}
              <div
                className="absolute top-[20%] left-1/2 -translate-x-1/2 w-[380px] h-[380px] bg-gradient-to-br from-blue-600/25 via-indigo-600/15 to-transparent rounded-full blur-[90px] pointer-events-none"
                aria-hidden="true"
              />

              {/* Seamless atmospheric portrait container — 100% sharp face, gentle perimeter feathering */}
              <div className="relative w-full h-full [mask-image:radial-gradient(ellipse_92%_86%_at_53%_38%,black_68%,rgba(0,0,0,0.85)_80%,transparent_100%)] [-webkit-mask-image:radial-gradient(ellipse_92%_86%_at_53%_38%,black_68%,rgba(0,0,0,0.85)_80%,transparent_100%)]">
                ...
                <div
                  className="absolute inset-x-0 bottom-0 h-32 sm:h-40 bg-gradient-to-t from-[#050508] via-[#050508]/80 to-transparent pointer-events-none"
                  aria-hidden="true"
                />

                {/* Left atmospheric soft fade toward the text column */}
                <div
                  className="absolute inset-y-0 left-0 w-20 sm:w-28 bg-gradient-to-r from-[#050508]/70 to-transparent pointer-events-none"
                  aria-hidden="true"
                />
              </div>
            </div>
